 ...
 * ... | MPO_INTR | MPI_INTR | ...
 */
#define IPU_IMR_MPI_INTR_M	0x7ULL
#define IPU_IMR_MPI_INTR_SHIFT	IPU_ISR_MIF_INTR_SHIFT
#define IPU_IMR_MPI_INTR_MASK	(IPU_IMR_MPI_INTR_M << IPU_IMR_MPI_INTR_SHIFT)
#define IPU_IMR_MPO_INTR_M	0x3ULL
#define IPU_IMR_MPO_INTR_SHIFT	(IPU_IMR_MPI_INTR_SHIFT + 3)
#define IPU_IMR_MPO_INTR_MASK	(IPU_IMR_MPO_INTR_M << IPU_IMR_MPO_INTR_SHIFT)
